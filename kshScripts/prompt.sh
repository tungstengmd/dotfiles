...
printf "\033[92m╭─{owo}─{"$(date +%H:%M)"}$([ $USER = root ] && echo "\033[91m" || echo "\033[93m") ${USER} \033[92min \033[30m\033[102m$(pwd | sed -e "s|^$HOME|~|" -e "s|\(\.\{0,1\}[^/]\)[^/]*/|\1/|g")\033[49m\033[92m$brnch $([ "$symb" = "" ] || echo "[$symb] ")$t$e%% \033[0m")'
