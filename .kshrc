...
trap 'i=0; [[ ${istrans:-u} = u  ]] || t="$(date +%s)"; [[ $istrans = 0 ]] && { tput cuu 2; tput ed; print -n "\E[92m\E[7m$(pwd | sed "s|^$HOME|~|")\E[27m-%\E[0m "; fc -lnN0 | sed "s/^[ \t]*//"; istrans=; }; failsafe=0' DEBUG || failsafe=1
